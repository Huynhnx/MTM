...
namespace MTM
{
    ...
    public class PipelineExecutor
    {
        ...
        public PipelineExecutor(Runspace runSpace,ISynchronizeInvoke invoker,string command, List<string> TestSelected)
        {
            ...
            //cmd.Parameters.Add("MTMRoot", "D:\\SourceControl\\MTM\\MTM - 2019");
            //cmd.Parameters.Add("ConfigDir", "\\tulsa.na.tibco.com\\org\\qa\\MTM\\ConfigFolders\\StaCLIConfigStatOptsOnly");
            //cmd.Parameters.Add("OutputDir", "C:\\CLI\\Results");
            //cmd.Parameters.Add("LogLevel", 6);
            //cmd.Parameters.Add("logFileName", "logfile");
            //cmd.Parameters.Add("LogSeq", "http://stat-server:5341");
            //cmd.Parameters.Add("StaCLIDir", "C:\\CLI\\Statistica.Engine");
            cmd.Parameters.Add("XmlConfig", "C:\\CLI\\JPMML_MTMs\\HuynhnxCfg.xml");
            cmd.Parameters.Add("TestCase", TestSelected);
